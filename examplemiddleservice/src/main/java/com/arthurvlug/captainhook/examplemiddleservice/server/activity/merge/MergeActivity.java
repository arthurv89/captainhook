...
import nl.arthurvlug.captainhook.exampleservice.clientlib.Client;
import nl.arthurvlug.captainhook.exampleservice.clientlib.ClientWrapperProvider;
...
public class MergeActivity extends AbstractExampleActivity<MergeInput, MergeOutput> {
    private Client exampleServiceClient = ClientWrapperProvider.getExampleserviceClient();

    private nl.arthurvlug.captainhook.exampleservice2.clientlib.Client exampleService2Client =
            nl.arthurvlug.captainhook.exampleservice2.clientlib.ClientWrapperProvider.getExampleservice2Client();
    ...
    public Observable<MergeOutput> enact(MergeInput mergeInput) {
        final HelloWorldInput input1 = HelloWorldInput.builder()
                ...
                .build();
        final nl.arthurvlug.captainhook.exampleservice2.activity.helloworld.HelloWorldInput input2 =
                nl.arthurvlug.captainhook.exampleservice2.activity.helloworld.HelloWorldInput.builder()
                .name(mergeInput.getName())
                .build();
